    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Ummu Qaltsum");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 1917051008);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "082278060182";
                Intent dialPhoneIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+phoneNumber));
                startActivity(dialPhoneIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Ummu Qaltsum");
                mPerson.setAge(1917051008);
                mPerson.setEmail("ummuqaltsum@gmail.com");
